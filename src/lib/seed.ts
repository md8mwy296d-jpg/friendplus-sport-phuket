...
] as Omit<User, 'avatarUrl' | 'avatarColor' | 'certified' | 'fairplayPct' | 'activityPct' | 'score' | 'reviewCount' | 'profilePct' | 'isAdmin' | 'isOwner'>[])
  .map((u) => ({ ...u, avatarUrl: '', avatarColor: null, certified: false, fairplayPct: null, activityPct: 0, score: null, reviewCount: 0, profilePct: 0, isAdmin: false, isOwner: false }));
