...
] as Omit<User, 'avatarUrl' | 'avatarColor' | 'certified' | 'fairplayPct' | 'activityPct' | 'score' | 'reviewCount'>[])
  .map((u) => ({ ...u, avatarUrl: '', avatarColor: null, certified: false, fairplayPct: null, activityPct: 0, score: null, reviewCount: 0 }));
